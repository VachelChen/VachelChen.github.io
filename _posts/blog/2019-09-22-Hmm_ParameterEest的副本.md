...
现在基本清楚了HMM建模大致流程，流程大致如下：

1. 把语音切片成25ms的语音帧
2. 提取39维的mfcc特征向量
3. 做GMM模型，计算miu和sigema方
4. 用EM算法迭代进行参数估计

接下来梳理一下细节，参考《The Application of Hidden Markov Models in Speech Recognition
》以及爱丁堡大学的《GMM&HMM》教材。
...
![argmax](/images/blog/argmax.jpg)

这里的L(θ)是连乘的，为了便于分析，我们可以定义对数似然函数，将其变成连加的：

![logsigema](/images/blog/logsigema.jpg)
